...
const ProjectsSection: React.FC = () => {
    ...
    const projects = [
        ...
        },
        {
            ...
            srcImg: projeto02,
            description: "Complete school management system developed with Django on the backend, React + TypeScript on the frontend and PostgreSQL as the database.",
            technologies: "Technologies: TypeScript, React, Django, PostgreSQL",
